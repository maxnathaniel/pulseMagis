...
import { BarChart3, Cloud, MessageSquare, MessageCircle, Type, type LucideIcon } from 'lucide-react'
import type { SlideType, ResponseMode, VerticalAlign } from './types.ts'
