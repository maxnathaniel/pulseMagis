...
import { C, FONT_DISPLAY, PALETTE_BARS, VERTICAL_ALIGN_CSS } from '../theme.js'
import { RichContentView } from './RichContentView.jsx'
...
// summary.
export function MiniSlidePreview({slide}){
  if (!slide) return (
  ...
  if (slide.type==='choice') {
    ...
    body=(
      <div style={{flex:1,minWidth:0,minHeight:0,overflow:'hidden',position:'relative',containerType:'inline-size'}}>
    ...
    body=(
      <div style={{flex:1,minWidth:0,minHeight:0,overflow:'hidden',display:'flex',flexDirection:'column',
        ...
        <div style={{fontFamily:FONT_DISPLAY,fontWeight:700,fontSize:12,color:C.txt1,textAlign:'center',
          overflow:'hidden',display:'-webkit-box',WebkitLineClamp:3,WebkitBoxOrient:'vertical',lineHeight:1.35}}>
          {question}
        </div>
      </div>
    )
