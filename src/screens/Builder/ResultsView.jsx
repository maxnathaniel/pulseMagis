...
import { C, FONT_DISPLAY, SLIDE_TYPES } from '../../theme.js'
import { ChoiceResults } from '../../components/results/ChoiceResults.jsx'
import { WordCloudResults } from '../../components/results/WordCloudResults.jsx'
import { OpenResults } from '../../components/results/OpenResults.jsx'
import { EmptyState } from '../../components/ui/EmptyState.jsx'
import { ConfirmDialog } from '../../components/ui/ConfirmDialog.jsx'

const RESULT_TYPES = ['choice', 'wordcloud', 'open']

export function ResultsView({draft}){
  const [responsesBySlide, setResponsesBySlide] = useState({})
              ...
              {relevantSlides.map(slide => {
                ...
                return (
                  <div key={slide.id}>
                    ...
                    {slide.type==='wordcloud'&& <WordCloudResults list={list}/>}
