...
export function RichTextToolbar({editor, verticalAlign, onVerticalAlignChange}) {
  ...
  return (
    <div style={{display:'flex',alignItems:'center',gap:1,flexWrap:'wrap',padding:'6px 8px',
      ...
      <ToolbarBtn title="More formatting (coming soon)" disabled><MoreHorizontal size={15}/></ToolbarBtn>
    </div>
  )
}
