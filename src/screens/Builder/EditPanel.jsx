...
import { AlignLeft, AlignRight, Image as ImageIcon, X, Copy } from 'lucide-react'
import { C, FONT_DISPLAY, RESPONSE_MODES } from '../../theme.js'
import { compressImage } from '../../lib/helpers.js'
import { SectionLabel } from '../../components/ui/SectionLabel.jsx'

const CONTENT_IMAGE_MAX_PX = 640

export function EditPanel({slide,onChange,onApplyToAll,onClose}){
    ...
    <div style={{width:280,flexShrink:0,borderLeft:`1.5px solid ${C.border}`,
      ...
      <div>
        ...
        <div style={{display:'flex',gap:8,marginTop:8}}>
          {[['left',AlignLeft,'Image left'],['right',AlignRight,'Image right']].map(([key,Icon,label])=>{
