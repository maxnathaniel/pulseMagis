...
import { C, FONT_DISPLAY, FONT_BODY, PALETTE_BARS } from '../../theme.js'
import { AudienceQna } from './AudienceQna.jsx'
import { RichContentView } from '../../components/RichContentView.jsx'

export function AudienceSlideView({session,slide,voted,choiceInput,setChoiceInput,textInput,setTextInput,submitting,onSubmit,qnaList,participantId,qnaDraft,setQnaDraft,qnaSubmitting,onSubmitQuestion}){
  return(
