...
import { AudienceSlideView } from './AudienceSlideView.jsx'

const ENDED_REDIRECT_DELAY_MS = 4000

export function Vote({session,slide,voted,choiceInput,setChoiceInput,textInput,setTextInput,submitting,onSubmit,onLeave,qnaList,participantId,qnaDraft,setQnaDraft,qnaSubmitting,onSubmitQuestion}){
